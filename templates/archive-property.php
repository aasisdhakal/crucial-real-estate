				...
				<main id="main" class="site-main">
					<div class="post-layout-matches-wrap">
						...
						<div class="post-filter-wrap">
							<div class="post-filter-item">
								...
								<div class="sort-property property-filter property-dropdown">
									<span class="property-filter-placeholder"><?php esc_html_e( 'Type', 'real-home' ); ?></span>
									<ul>
										<li><a data-sortby="default" href="
											<?php
											$real_home_post_sort = add_query_arg( array( 'type' => 'default' ) );
											echo esc_url( $real_home_post_sort )
											?>
												"
										       title="<?php esc_attr_e( 'Default', 'real-home' ); ?>"><?php esc_html_e( 'Default', 'real-home' ); ?></a>
										</li>
										
										<?php foreach ( $real_home_cats as $real_home_cat ) : ?>
											<li><a data-sortby="default" href="
												<?php
												$real_home_post_sort = add_query_arg( array( 'type' => $real_home_cat->slug ) );
												echo esc_url( $real_home_post_sort )
												?>
													"
											       title="<?php echo esc_attr( ucwords( $real_home_cat->name ) ); ?>"><?php echo esc_html( $real_home_cat->name ); ?></a>
											</li>
										<?php endforeach; ?>
									</ul>
								</div>
						...
						<div class="post-wrapper post-grid-view">
							...
							if ( ( isset( $_GET['type'] ) && ! empty( $_GET['type'] ) ) && ( $_GET['type'] != 'default' ) ) {
