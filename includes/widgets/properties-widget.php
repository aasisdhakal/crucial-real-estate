	...
	class Inspiry_Properties_Widget extends WP_Widget
	{
		...
		function __construct()
		{
			$widget_ops = array(
				...
				'description'                 => esc_html__('Displays Properties based on custom filters.', 'crucial-real-estate'),
				'customize_selective_refresh' => true,
			);
			parent::__construct(
				'Inspiry_Properties_Widget',
				esc_html__('Crucial Real Estate - Properties', 'crucial-real-estate'),
				$widget_ops
			);
		}
		...
		function widget($args, $instance)
		{
			...
			$prop_query = new WP_Query(apply_filters('cre_properties_widget', $prop_args));
...
?>
				...
				?>
					<ul class="featured-properties">
						<?php
						echo '<li>';
						esc_html_e('No Property Found!', 'crucial-real-estate');
						echo '</li>';
						?>
					</ul>
					<?php
				...
				if ($prop_query->have_posts()) :
					...
					<div class="rh_alert-wrapper rh_alert__widget">
						<h4 class="no-results"><?php esc_html_e('No Property Found!', 'crucial-real-estate'); ?></h4>
					</div>
			<?php
				endif;
			}
		...
		function form($instance)
		{
			...
			$instance = wp_parse_args(
				(array) $instance,
				array(
					'title'   => esc_html__('Properties', 'crucial-real-estate'),
					'count'   => 1,
					'sort_by' => 'random',
			...
			?>
				...
				<p class="tax-option">
					<label for="<?php echo esc_attr($this->get_field_id('property_location')); ?>"><strong><?php esc_html_e('Property Location:', 'crucial-real-estate'); ?></strong></label><br>
					<?php
					$selected_locations = '';
			...
			?>
				...
				<p class="tax-option">
					<label for="<?php echo esc_attr($this->get_field_id('property_status')); ?>"><strong><?php esc_html_e('Property Status:', 'crucial-real-estate'); ?></strong></label><br>
					<?php
					$selected_statuses = '';
			...
			?>
				...
				<p class="tax-option">
					<label for="<?php echo esc_attr($this->get_field_id('property_type')); ?>"><strong><?php esc_html_e('Property Types:', 'crucial-real-estate'); ?></strong></label><br>
					<?php
					$selected_types = '';
			...
			?>
				...
				<p class="tax-option">
					<label for="<?php echo esc_attr($this->get_field_id('property_feature')); ?>"><strong><?php esc_html_e('Property Feature:', 'crucial-real-estate'); ?></strong></label><br>
					<?php
					$selected_features = '';
...
if (!function_exists('aarambha_register_properties_widget')) {
	function aarambha_register_properties_widget()
	{
		register_widget('Inspiry_Properties_Widget');
	}

	add_action('widgets_init', 'aarambha_register_properties_widget');
}
