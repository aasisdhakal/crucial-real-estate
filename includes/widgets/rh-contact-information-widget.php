...
/**
 * Widget: Crucial Real Estate Contact Information
 */
if (!class_exists('RH_Contact_Information')) :
	 ...
	 *
	 * Contact Information widget for Crucial Real Estate.
	 *
	 * @since 3.0.0
	 */
	class RH_Contact_Information extends WP_Widget
	{
		...
		function __construct()
		{
			$widget_ops = array(
				...
				'description'                 => esc_html__('Displays general contact information.', 'crucial-real-estate'),
				'customize_selective_refresh' => true,
			);
			parent::__construct('RH_Contact_Information', esc_html__('Crucial Real Estate - Contact Information', 'crucial-real-estate'), $widget_ops);
		}
...
?>
			<div class="rh_contact_widget">
				...
				<?php if (!empty($address)) : ?>
					<div class="rh_contact_widget__item rh_contact_widget--alignBaseline">
						<p class="icon"><?php include(CRE_PLUGIN_DIR . '/images/icons/icon-marker.svg'); ?></p>
				...
				<?php if (!empty($number)) : ?>
					<div class="rh_contact_widget__item rh_contact_widget--alignBaseline">
						<p class="icon"><?php include(CRE_PLUGIN_DIR . '/images/icons/icon-' . esc_html($number_icon) . '.svg'); ?></p>
						<?php
				...
				<?php if (!empty($email)) : ?>
					<div class="rh_contact_widget__item rh_contact_widget--alignBaseline">
						<p class="icon"><?php include(CRE_PLUGIN_DIR . '/images/icons/icon-mail.svg'); ?></p>
		...
		function form($instance)
		{
			$instance = wp_parse_args((array) $instance, array(
				'title'   => '',
				'address' => esc_html__('3015 Grand Ave, Coconut Grove, Merrick Way, FL 12345', 'crucial-real-estate'),
				'number'  => esc_html__('+123-456-789', 'crucial-real-estate'),
				'email'   => esc_html__('robot@inspirythemes.com', 'crucial-real-estate'),
			));
		...
		?>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title', 'crucial-real-estate'); ?></label>
				<input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
			</p>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('address')); ?>"><?php esc_html_e('Contact Address', 'crucial-real-estate'); ?></label>
				<input class="widefat" id="<?php echo esc_attr($this->get_field_id('address')); ?>" name="<?php echo esc_attr($this->get_field_name('address')); ?>" type="text" value="<?php echo esc_attr($address); ?>" />
			</p>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e('Phone Number', 'crucial-real-estate'); ?></label>
			...
			<p>
				...
				<label for="<?php echo esc_attr($this->get_field_id('icon')); ?>"><?php esc_html_e('Use WhatsApp icon for the phone number?', 'crucial-real-estate'); ?></label>
			</p>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('email')); ?>"><?php esc_html_e('Email', 'crucial-real-estate'); ?></label>
