...
if (!class_exists('Property_Types_Widget')) {
	 ...
	 *
	 * Display Available Property Types for Crucial Real Estate
	...
	class Property_Types_Widget extends WP_Widget
	{
		...
		function __construct()
		{
			$widget_ops = array(
				...
				'description'                 => esc_html__('This widget displays a list of Property Types.', 'crucial-real-estate'),
				'customize_selective_refresh' => true,
			);
			parent::__construct('property_types_widget', esc_html__('Crucial Real Estate - Property Types', 'crucial-real-estate'), $widget_ops);
		}
		...
		function widget($args, $instance)
		{
			...
			if (empty($title)) {
				$title = esc_html__('Property Types', 'crucial-real-estate');
			}
...
<?php
		...
		{
			$property_type_parent_terms_args = apply_filters('cre_property_types_parent_terms', array(
			...
			if (0 < count($property_type_parent_terms)) {
				...
				foreach ($property_type_parent_terms as $property_type_parent_term) {
					...
					$property_type_child_terms = get_terms(
						apply_filters('cre_property_types_child_terms', array(
							'taxonomy' => 'property-type',
