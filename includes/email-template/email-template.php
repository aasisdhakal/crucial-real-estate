...
$header_content     = get_option('cre_email_template_header_content', 'image');
$header_title_color = get_option('cre_email_template_header_title_color', '#333333');
$background_color   = get_option('cre_email_template_background_color', '#e9eaec');
$body_link_color    = get_option('cre_email_template_body_link_color', '#ff7f50');
$footer_text        = get_option('cre_email_template_footer_text', '');
$footer_text_color  = get_option('cre_email_template_footer_text_color', '#aaaaaa');
$footer_link_color  = get_option('cre_email_template_footer_link_color', '#949494');
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;border: 0;max-width: 600px !important;">
						...
						if ('none' !== $header_content) {
							if ('image' === $header_content || 'both' === $header_content) {
								$header_image = get_option('cre_email_template_header_image');
							...
							if ('title' === $header_content || 'both' === $header_content) {
								$header_title = get_option('cre_email_template_header_title');
														...
														<tr>
															<td valign="top" class="mcnTextContent" style="padding-top: 9px;padding-right: 18px;padding-bottom: 9px;padding-left: 18px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;color: <?php echo $footer_text_color; ?>;font-family: Helvetica;font-size: 12px;line-height: 150%;text-align: center;">
																...
																if (!empty($footer_text)) {
																	...
																	echo esc_html__('Sent from ', 'crucial-real-estate') . '<a href="' . esc_url(home_url()) . '" style="color:' . esc_html($footer_link_color) . ';">' . wp_specialchars_decode($blog_info) . '</a>';
																}
																?>
															</td>
														</tr>
